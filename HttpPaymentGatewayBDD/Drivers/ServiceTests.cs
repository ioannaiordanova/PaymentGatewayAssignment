...
namespace HttpPaymentGatewayBDD
{
    public class Tests
    {
        ...
        {
            PaymentDetails _transaction = new PaymentDetails() { ReferenceId = _validTransaction.UniqueId, TransactionType = "void" };
        ...
        {
            PaymentDetails _transaction = new PaymentDetails() { ReferenceId = _voidTransaction.UniqueId, TransactionType = "void" };
