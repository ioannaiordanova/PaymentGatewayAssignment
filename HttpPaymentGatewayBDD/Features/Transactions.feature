...
Scenario Outline:1 Successfull Sale Transaction
	Given I am authorized
	When I submit my payment details:
		| Card Number  | Cvv   | Expiration Date   | Amount   | Usage   | Card Holder   | Email   | Address  |
		| <CardNumber> | <Cvv> | <Expiration Date> | <Amount> | <Usage> | <Card Holder> | <Email> | <Adress> |
	Then I have the status code 200

Examples:
		| CardNumber       | Cvv | Expiration Date | Amount | Usage       | Card Holder | Email             | Address             |
		| 4200000000000000 | 123 | 06/2019         | 500    | Coffeemaker | Panda Panda | panda@example.com | Panda Street, China |

Scenario Outline:2 Unauthorized Sale Transaction
...
Scenario:3 Successfull Void Transaction
	Given I am authorized
	When I try to void my previous sale transaction
	Then I have the status code 200
